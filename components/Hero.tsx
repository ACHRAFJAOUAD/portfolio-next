...
export default function Hero() {
  return (
    <section id="hero" className="min-h-screen flex items-center bg-[#1e1e1e] pt-10">
      <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center" style={{paddingLeft: '3rem', paddingRight: '3rem'}}>
        <div>
          <p className="font-mono text-[#6a9955] text-sm mb-2">// Hello, World!</p>
          <h1 className="font-mono text-4xl md:text-5xl font-bold text-white mb-2">
            <span className="text-[#569cd6]">const</span>{" "}
            <span className="text-[#4ec9b0]">developer</span>{" "}
            <span className="text-white">=</span>
          </h1>
          <h2 className="font-mono text-2xl md:text-3xl text-[#ce9178] mb-4">
            &quot;{portfolioData.name}&quot;
          </h2>
          ...
          <div className="flex gap-4 flex-wrap">
            <a
              href="/contact"
              className="btn font-mono text-sm bg-[#0e639c] hover:bg-[#1177bb] text-white rounded transition-colors"
            >
              getInTouch()
            </a>
            <a
              ...
              className="btn font-mono text-sm border border-[#3c3c3c] hover:border-[#569cd6] text-[#cccccc] hover:text-white rounded transition-colors"
            >
              viewGithub()
            </a>
          </div>
